...
from quantum_nn.benchmarks import BenchmarkRunner, run_classical_comparison, get_benchmark_task
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Run quantum neural network benchmarks")
    parser.add_argument(
        "--task", type=str, default="binary_classification",
        choices=[
            "binary_classification", "multiclass_classification", 
            "regression", "moons", "digits", 
            "quantum_simulation", "entanglement_classification"
        ],
        help="Benchmark task"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--quantum-layers", type=int, default=2,
    ...
    parser.add_argument(
        ...
        help="Compare with classical models"
    )
    parser.add_argument(
...
def main():
    ...
    print(f"Creating quantum model with {args.qubits} qubits and {args.quantum_layers} layers")
