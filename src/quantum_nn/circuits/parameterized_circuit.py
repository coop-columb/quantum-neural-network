...
class ParameterizedCircuit:
    ...
    def _create_encoder(
        self, encoder: Optional[Union[str, QuantumEncoder]], kwargs: Optional[Dict[str, Any]]
        ...
        if encoder.lower() == "amplitude":
            ...
            sub_encoders = kwargs.pop("encoders", [
    ...
    def _create_template(
        self, template: Optional[Union[str, QuantumCircuitTemplate]], kwargs: Optional[Dict[str, Any]]
        ...
        if template.lower() == "strongly_entangling":
            ...
            block_template = kwargs.pop("block_template", StronglyEntanglingLayers(
                self.n_qubits, n_layers=1
            ))
            return QuantumResidualLayers(self.n_qubits, block_template=block_template, **kwargs)
        else:
