...
class QuantumLayer(tf.keras.layers.Layer):
    ...
    def call(self, inputs, training=None):
        ...
        result = tf.py_function(
            func=quantum_function, inp=[inputs, self.quantum_weights], Tout=tf.float32
        )
...
def create_quantum_layer(
    n_qubits: int = 4, n_layers: int = 2, measurement_type: str = "expectation"
) -> QuantumLayer:
    """
    ...
    """
    return QuantumLayer(n_qubits=n_qubits, measurement_type=measurement_type)
