...
class DataConfig:
    ...
    dataset_url: str = "https://www.kaggle.com/datasets/paultimothymooney/chest-xray-pneumonia"
    ...
    def get_data_stats(self) -> dict:
        ...
        return {
            ...
            "image_size": {
                ...
                "reduction_factor": self.original_image_size[0] / self.quantum_image_size[0]
            },
            "features": {
