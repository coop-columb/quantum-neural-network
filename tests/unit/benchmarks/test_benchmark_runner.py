...
class TestBenchmarkRunner:
    ...
    def test_initialization(self):
        ...
        runner = BenchmarkRunner(
            output_dir=self.temp_dir, metrics=custom_metrics, verbose=0
        )
    ...
    def test_compare_models(self):
        ...
        # Create mock models
        models = {"model_1": MockQuantumModel(), "model_2": MockQuantumModel()}
        ...
        assert os.path.isfile(
            os.path.join(comparison_dir, "performance_comparison.png")
        )
