...
class TestMedicalQuantumClassifier:
    ...
    def test_factory_function(self):
        ...
        classifier = create_medical_quantum_classifier(
            input_shape=(10,), n_classes=2, circuit_complexity="simple"
        )
    ...
    def test_forward_pass(self):
        ...
        classifier = MedicalQuantumClassifier(n_qubits=4, n_layers=1, n_classes=2)
    ...
    def test_config_serialization(self):
        ...
        classifier = MedicalQuantumClassifier(
            n_qubits=6, n_layers=3, circuit_type="convolution", encoding_type="hybrid"
        )
...
class TestMedicalHybridModel:
    ...
    def test_factory_function(self):
        ...
        model = create_hybrid_medical_model(
            input_shape=(32, 32, 3), n_classes=2, model_size="small"
        )
